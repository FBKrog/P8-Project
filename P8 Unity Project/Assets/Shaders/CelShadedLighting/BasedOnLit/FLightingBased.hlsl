#ifndef FELIX_LIGHTING_INCLUDED
#define FELIX_LIGHTING_INCLUDED

// FBRDFBased is altered as it computes the bidirectional reflectance distribution function, aka reflections
#include "Assets/Shaders/CelShadedLighting/BasedOnLit/FBRDFBased.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Debug/Debugging3D.hlsl"
#include "Assets/Shaders/CelShadedLighting/BasedOnLit/FGlobalIlluminationBased.hlsl"
...
// Custom begin
half HalfLambertIfy(half twoLongRange)
{
    return (twoLongRange + 1) * 0.5;
}

half CelStep(half lightLevel)
{
    half stepped = step(0.5, lightLevel);
    return stepped;
}
// Custom end
...
half3 LightingLambert(half3 lightColor, half3 lightDir, half3 normal)
{
    ...
    half NdotL = HalfLambertIfy(dot(normal, lightDir));
    return lightColor * CelStep(NdotL);
}

// Modified
// TODO: Make specular work as 
    ...
    half clearCoatMask, bool specularHighlightsOff)
{
    ...
    // Light attenuation seems to be what most affects the odd lighting pattern
    half NdotL = HalfLambertIfy(dot(normalWS, lightDirectionWS));
    half3 radiance = lightColor * (CelStep(lightAttenuation) * CelStep(NdotL));
...
half3 LightingPhysicallyBased(BRDFData brdfData, BRDFData brdfDataClearCoat, Light light, half3 normalWS, half3 viewDirectionWS, half clearCoatMask, bool specularHighlightsOff)
{
    ...
    return LightingPhysicallyBased(brdfData, brdfDataClearCoat, light.color, light.direction, pow(light.distanceAttenuation, 0.1) * light.shadowAttenuation, normalWS, viewDirectionWS, clearCoatMask, specularHighlightsOff);
}
...
half3 CalculateBlinnPhong(Light light, InputData inputData, SurfaceData surfaceData)
{
    ...
    half3 attenuatedLightColor = light.color * CelStep(pow(light.distanceAttenuation, 0.1) * light.shadowAttenuation);
    half3 lightDiffuseColor = LightingLambert(attenuatedLightColor, light.direction, inputData.normalWS);
...
///////////////////////////////////////////////////////////////////////////////
/// PBR lighting...
/// This is the part that I am to alter the most of  the non-lighting functions
///////////////////////////////////////////////////////////////////////////////
