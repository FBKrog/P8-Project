#ifndef FELIX_BRDF_INCLUDED
#define FELIX_BRDF_INCLUDED
...
// Custom begin
half CelStepSpecular(half lightLevel)
{
    half stepped = step(1.0, lightLevel);
    return stepped;
}

half CelStepMetallic(half lightLevel)
{
...
half DirectBRDFSpecular(BRDFData brdfData, half3 normalWS, half3 lightDirectionWS, half3 viewDirectionWS)
{
    ...
    // Stepped, then multiplied by 8 to mimic specular dot power
    return CelStepSpecular(specularTerm) * 8.0;
}
